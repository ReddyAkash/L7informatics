...
from app.models import Group, GroupMember, GroupExpense, ExpenseShare, Expense, User
...
class GroupManager:
    ...
    def get_group_members(self, group_id):
      ...
      return [member[0] for member in members]  # member is a tuple with 1 string value
